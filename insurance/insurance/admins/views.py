...
def admin_add_category(request):
    ...
    return render(request,'admin_add_category.html',{'categoryForm':categoryForm})
...
def admin_add_policy(request):
    ...
    return render(request,'admin_add_policy.html',{'policyForm':policyForm})
...
def update_policy(request,pk):
    ...
    return render(request,'update_policy.html',{'policyForm':policyForm})
...
def admin_view_policy_holder(request):
    policyrecords = models.PolicyRecord.objects.all()
    return render(request,'admin_view_policy_holder.html',{'policyrecords':policyrecords})

def admin_view_approved_policy_holder(request):
    policyrecords = models.PolicyRecord.objects.all().filter(status='Approved')
    return render(request,'admin_view_approved_policy_holder.html',{'policyrecords':policyrecords})
...
def admin_view_disapproved_policy_holder(request):
    policyrecords = models.PolicyRecord.objects.all().filter(status='Disapproved')
    return render(request,'admin_view_disapproved_policy_holder.html',{'policyrecords':policyrecords})
...
def admin_view_waiting_policy_holder(request):
    policyrecords = models.PolicyRecord.objects.all().filter(status='Pending')
    return render(request,'admin_view_waiting_policy_holder.html',{'policyrecords':policyrecords})



def admin_question(request):
    questions = models.Question.objects.all()
    return render(request,'admin_question.html',{'questions':questions})
...
def update_question(request,pk):
    ...
    return render(request,'update_question.html',{'questionForm':questionForm})